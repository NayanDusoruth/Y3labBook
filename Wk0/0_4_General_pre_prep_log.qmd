# Wk 0.4 General pre-prep log

## Lab log 15/01/2026

Added recommended textbook to bibliography [@ComplexityAndCriticality].



## Lab log 19/01/2026
Briefly discussed lab w/Dr Turci; he noted the "percolation" chapter in [@ComplexityAndCriticality] as a good starting point since it introduces many ideas relating to phase transitions that will be useful for this project
...
* Go through "percolation" chapter [@ComplexityAndCriticality] - (in retrospect this may take a while) - note section 1.8 supposedly outlines extraction of critical exponents 
...
* Refactor code in a .py file - jupyter notebooks are more annoying to work with in my experience
	* Additional benefit: lets me use my personal library ([NayanGeneralUtils](https://github.com/NayanDusoruth/NayanGeneralUtils)) which may be useful
