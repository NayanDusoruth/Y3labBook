...
## Foreword:
During Wk1 I worked on the code basics for the simulation whilst my lab partner Scarlett produced a robust literature review on the topic.
This page is intended to summarise and notate the findings of that and similar readings.
This review relied on [@ClusterLink1][@ClusterLink2][@ClusterLink3][@ClusterLink4[@ClusterDombAndStolS][@ClusterLink6]
...
### Cluster shape:
It is useful to define a "cyclomatic number" for any cluster [@ClusterDombAndStolS]:
